...
function renderTasks () {
	const zeroStateUI = document.getElementById('zero-state-ui');
	const activeListUI = document.getElementById('active-list-ui');
	...
	document.getElementById('current-list-title').textContent = activeList.name;
